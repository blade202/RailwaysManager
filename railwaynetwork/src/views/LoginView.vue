        ...
        <div class="main-login-container # w-full h-screen bg-[url('/public/pictures/logintestbg.jpg')] bg-left bg-cover bg-fixed bg-no-repeat">
            ...
            <div
                ...
                <div
                    ...
                    <button @click="GotoRegister" class="grid p-2 m-auto mt-1 transition duration-300 ease-in-out border-2 border-solid rounded-lg xl:w-2/6 lg:w-2-6 md:w-2/6 sm:w-2/4 border-lightgray text-lightgray hover:bg-lightgray hover:text-darkgray">
                    Hozza létre most!
                    </button>
                </div>
            </div>
