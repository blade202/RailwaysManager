<template>
    <div id="register">
        <div class="main-register-container # w-full h-screen bg-[url('/public/pictures/loginregistrybg.jpg')] bg-left bg-fixed bg-no-repeat">
            <div
                class="main-register-content # p-4 fixed top-1/3 left-1/2 -translate-y-1/2 -translate-x-1/2 font-mainfont grid lg:w-2/5 md:w-2/3 sm:w-full xs:w-full">
                <!--Title-->
                <h1 id="title"
                ...
                <!-- registrycontent -->
                <div
                    class="register-content # backdrop-blur-sm bg-gray-600 flex flex-col bg-transparent/60 pt-16 pb-16 rounded-3xl">
